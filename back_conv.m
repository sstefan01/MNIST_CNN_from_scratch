...
function [dw, dconv1, db] = back_conv(conv1, dconv2,w)
...
dw = dw_back(conv1,dconv2);


kern = rot90(w,2);
dconv2 = padarray(dconv2, [size(kern,1)-1, size(kern,2)-1],0);

%dconv1 = dconv_back(dconv2,kern);
dconv1 = vectorized_conv(dconv2,permute(kern, [1 2 4 3]), 0);
